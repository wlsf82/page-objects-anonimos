  ...
  return (
    <>
      ...
      <main>
        ...
        <p>Por fim, conheça o projeto <a href="https://github.com/wlsf82/gitlab-cypress" target="_blank" rel="noreferrer"><code>gitlab-cypress</code></a>, o qual não faz uso do padrão Page Objects, e ainda assim, preza por questões de legibilidade, manutenabilidade, escalabilidade, etc.</p>
        <br></br>
        <hr />
        <br></br>
      </main>
